...
public class LockDurationTest {

    private final static Logger LOGGER = Logger.getLogger(LockDurationTest.class.getName());
    ...
    public static void main(String[] args) {
        ...
        client.subscribe("lock-duration")
                ...
                .handler((externalTask, externalTaskService) -> {
                    ...
                    System.out.println(formatter.format(date)+"# execute lock-duration instance1");
                    try {
                        Thread.sleep(60*1000);
                        Date date2 = new Date(System.currentTimeMillis());
                        System.out.println(formatter.format(date2)+"# complete lock-duration instance1");
